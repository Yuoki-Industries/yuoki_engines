...
data:extend({
	...
	--YI-Engines/Experiments
	{
		...
		name = "yi_engines",
		icon_size = 64,
		icon = "__yi_engines__/graphics/yi-engines-icon.png",
		inventory_order = "y",
		order = "yi-e1",
	},
	--YI-Agronomie
	{
		...
		name = "yie_harvest",
		icon_size = 64,
		icon = "__yi_engines__/graphics/yi_engines_harvest.png",
		inventory_order = "y",
		order = "yi-e2",
	},
	...
	{ type = "recipe-category", name = "yrcat-mf1gm" }, --mechanical force primary - gasmotor
	...
	--27.4.2022
	{ type = "recipe-category", name = "yrcat_rheinsberg" }, --für rheinsberg-reactor
})
