data:extend({
	...
	-- Trade Node
	{
		...
		name = "ye_trade_node",
		icon_size = 32,
		icon = "__yi_engines__/graphics/icons/trade_node_icon.png",
		flags = { "placeable-neutral", "placeable-player", "player-creation" },
		...
		graphics_set = {
			animation = {
				layers = {
					{
						filename = "__yi_engines__/graphics/entity/trade_node_sheet.png",
						width = 192,
						height = 192,
						scale = 0.5,
						shift = { 0.5, -0.5 },
		...
		graphics_set = {
			animation = {
				north = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/can-s.png",
							width = 128,
							height = 128,
							shift = { 0.5, -0.25 },
							frame_count = 16,
				...
				east = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/can-w.png",
							width = 128,
							height = 128,
							shift = { 0.5, -0.3125 },
							frame_count = 16,
				...
				south = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/can-n.png",
							width = 128,
							height = 128,
							shift = { 0.5, -0.375 },
							frame_count = 16,
				...
				west = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/can-e.png",
							width = 128,
							height = 128,
							shift = { 0.25, -0.375 },
							frame_count = 16,
