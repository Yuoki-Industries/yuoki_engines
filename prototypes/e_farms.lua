data:extend({
		...
		graphics_set = {
			animation = {
				north = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/farm-sheet-ns.png",
							width = 192,
							height = 192,
							shift = { 0.44, -0.22 },
							frame_count = 16,
				...
				east = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/farm-sheet-ew.png",
							width = 192,
							height = 192,
							shift = { 0.19, -0.34 },
							frame_count = 16,
		...
		graphics_set = {
			animation = {
				north = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/cage/cage_v14.png",
							width = 192,
							height = 192,
							shift = { 0.375, -0.125 },
							frame_count = 36,
				...
				east = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/cage/cage_h14.png",
							width = 192,
							height = 192,
							shift = { 0.125, -0.5 },
							frame_count = 36,
	...
	-- fishing
	{
		...
		name = "ye_pool",
		icon_size = 32,
		icon = "__yi_engines__/graphics/entity/pool_icon.png",
		flags = { "placeable-neutral", "placeable-player", "player-creation" },
		...
		graphics_set = {
			animation = {
				north = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/pool_sn_sheet.png",
							width = 384,
							height = 384,
							shift = { 0.44, -0.22 },
							frame_count = 9,
				...
				east = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/pool_we_sheet.png",
							width = 384,
							height = 384,
							shift = { 0.19, -0.34 },
							frame_count = 9,
				...
				south = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/pool_ns_sheet.png",
							width = 384,
							height = 384,
							shift = { 0.44, -0.22 },
							frame_count = 9,
				...
				west = {
					layers = {
						{
							filename = "__yi_engines__/graphics/entity/pool_ew_sheet.png",
							width = 384,
							height = 384,
							shift = { 0.19, -0.34 },
							frame_count = 9,
